...
export const jobDescription: JobDescriptionType = {
    MM: {
        ...
        Software: [
            ...
            "Develop UI/UX of the website or Mobile App with the help of Graphic committee.",
            "Participate in regular code reviews to maintain code quality, ensure consistency, and share knowledge within the team.",
            "Participate in brainstorming sessions to contribute ideas for app enhancements, new features, and improvements to help other committees.",
    ...
    AC: {
        Freelancing: [
            ...
            "Designing the session’s flow and activities.",
            "Preparing and training to become more qualified as Moderators.",
            "Moderating workshop’s sessions (Graphic Design-Montage) and follow up with the participants.",
        ...
        Engineering: [
            ...
            "Designing the session’s flow and activities.",
            "Preparing and training to become more qualified as Moderators.",
            "Moderating workshop’s sessions (Python-Machine-Front End) and follow up with the participants.",
            "Holding interviews and making the election of the participants in coordination with the HR.",
            "Organizing and designing the project day.",
        ],
        Juniors: [
